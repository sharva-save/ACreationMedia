...
//             Welcome To <span className="text-[#fff005]">    A.Creative Media</span>
//           </h1>
//           <p className={`${styles.heroSubText} mt-2 text-white-100`}>
//             Think Creative Be Creative
//           </p>
//           {/* <img className="lg:mt-[-200px] md:mt-0" src={creativeMedia} alt="Creative Media" /> */}
//           <motion.img
//   className="lg:mt-[-200px] md:mt-0"
//   src={creativeMedia}
//   alt="Creative Media"
...
//     transition: { 
//       duration: 0.3,  // Faster hover transition
//       ease: "easeOut" 
//     } 
//   }}
// />
...
//            animate={{ opacity: 10, scale: 4 }}
//            transition={{ duration: 5, ease: "easeOut" }}
//            className="absolute w-5 h-5 rounded-full bg-[#fff] opacity-10"
//            style={{
//              left: bubble.x - 10,
//              top: bubble.y - 10,
//            }}
...
"
    ...
    >
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} mt-[-20px] text-white`}>
            Welcome To   <span className="text-[#fff005] sm:text-center sm:text-[31px] lg:text-7xl"> A.Creative Media</span>
          </h1>
          <p className={`${styles.heroSubText} text-right lg:pr-[100px] lg:mt-[-10px] text-white-100`}>
              Think Creative Be Creative
          </p>
    ...
    src={creativeMedia}
    alt="Creative Media"
    initial={{ opacity: 0, y: 10, scale: 0.50 }}  // Explicit normal scale
  ...
  return (
    <motion.div
      ...
      transition={{
        ...
        ease: [0.2, 0.8, 0.4, 1],
        opacity: { duration: bubble.lifetime / 1000 * 0.7, ease: "circOut" }
      }}
      style={{
        position: 'absolute',
        width: bubble.size,
